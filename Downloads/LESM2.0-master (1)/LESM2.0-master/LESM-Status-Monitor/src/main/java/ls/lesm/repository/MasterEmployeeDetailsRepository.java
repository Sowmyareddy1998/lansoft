...
//			PageRequest of ,List<EmployeeStatus> status);
	...
	public List<MasterEmployeeDetails> findByDesignationsAndSubDepartmentsAndLancesoftContaining(Designations DesgNames,
			SubDepartments SubDepartmentNames, String lancesoftId);
